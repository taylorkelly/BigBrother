...
public class Finder {
    ...
    private void mysqlFind() {
        ...
        try {
            ...
            ps = conn.prepareStatement("SELECT player, count(player) AS modifications FROM " + BBDataTable.getTableName() + " WHERE " + actionString
    ...
    private void mysqlFind(String playerName) {
        ...
        try {
            ...
            // TODO maybe more customizable actions?
            String actionString = "action IN('" + Action.BLOCK_BROKEN.ordinal() + "', '" + Action.BLOCK_PLACED.ordinal() + "', '" + Action.LEAF_DECAY.ordinal() + "', '" + Action.TNT_EXPLOSION.ordinal() + "', '" + Action.CREEPER_EXPLOSION.ordinal() + "', '" + Action.MISC_EXPLOSION.ordinal() + "', '" + Action.LAVA_FLOW.ordinal() + "', '" + Action.BLOCK_BURN.ordinal() + "')";
            ps = conn.prepareStatement("SELECT action, type FROM " + BBDataTable.getTableName() + " WHERE " + actionString
